                    ...
                    <div className="col-md-6 mb-0">
                      ...
                      <div className="form-group">
                        <Field
                          ...
                          className={`form-control ${
                            touched?.fields?.city && errors?.fields?.city
                              ? "is-invalid"
                              : ""
                          }`}
                        />
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        <Field
                          ...
                          placeholder="UF Estado *"
                          className={`${
                            touched?.fields?.state && errors?.fields?.state
                              ? "is-invalid"
                              : ""
                          }`}
                          style={{
                      ...
                      <div className="form-group">
                        <Field
                          ...
                          className={`form-control ${
                            touched?.fields?.cityDestiny &&
                            errors?.fields?.cityDestiny
                              ? "is-invalid"
                              : ""
                          }`}
                        />
                  ...
                  <div className="col-14">
                    ...
                    <div className="form-group">
                      <Field
                        ...
                        onblur="this.placeholder = 'Sua mensagem'"
                  ...
                  <div className="col-md-14 text-center">
                    <button
                      ...
                      style={{
                        ...
                        padding: "14px 44px",
                        background:
                          "linear-gradient(to right, #5b4dbb, #6f5de3)",
                      }}
                    >
                      {"Enviar"}
                    </button>
